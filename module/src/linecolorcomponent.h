...
namespace nap
{
	...
	public:
		...
		ResourcePtr<PolyLine> mLine;					//< Property 'Line':
		...
		ResourcePtr<ParameterFloat>  mIntensity;
		ResourcePtr<ParameterRGBColorFloat> mColorOne;		///< First Color
		ResourcePtr<ParameterRGBColorFloat> mColorTwo;		///< Second Color
	};
